 ymaps.ready(init); //как только загрузится API и будет готов DOM, начнет выполняться фун-я init
 
function init() {
  var map = new ymaps.Map('map', {
    center: [59.93863106, 30.32305450],//http://dimik.github.io/ymaps/examples/location-tool/
    zoom: 17,
